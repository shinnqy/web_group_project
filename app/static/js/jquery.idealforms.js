...
$.idealforms.errors = {
  ...
  digits: 'Has to be the only number.',
  name: 'At least 3 letters, letters only.',
  username: '4-32 letters, begin with letters(.)',
  pass: '必须至少6个字符长，并且至少包含一个数字，一个大写字母和一个小写字母.',
  strongpass: 'At least 8 characters, including 1 uppercase, 1 lowercase letter and 1 number or special character.',
  email: 'Has to be a valid e-mail address. <em>(e.g. user@gmail.com)</em>',
...
var _defaults = {
  ...
  customFlags: {},
  globalFlags: '',
  onSuccess: function(e) { alert('Congratulations!! You have registered successfully! Please log in now!')},
